...
class Stickman(object):
    ...
    def __init__(self, way_to_stickman_sprites, way_to_customization_sprites):
        ...
        for i in range(0, len(self.all), 7):
        ...
        self.offset_x = 0
        self.offset_y = 0
        self.number_of_sprites = int(len(self.all) / 7)
        self.start_ident = 1
        self.counter = 0
...
z = Stickman("Stickmen/Stickman_exercise/Stickman_exercise.txt", "Customization resources/Hat-1.png")
tk.focus_set()
tk.mainloop()
